...
//		add duplicate key...which can see updating (replacing)value
		m.put(1, "u");
		m.put(null, "g"); // one null key allowed 
		m.put(null, "i"); // second null key added, the value of first null key updated second null key value
		m.put(1, null); // null value allowed 
